...
import torch
import numpy as np
from src.krong_tokenizer import KrongBertTokenizer
...
TOKENIZER_CLASSES = {
    ...
    "ourbert":KrongBertTokenizer
}

MODEL_FOR_SEQUENCE_CLASSIFICATION = {
    "prev": BertForSequenceClassification,
    ...
    "ourbert": BertForSequenceClassification
}

MODEL_FOR_TOKEN_CLASSIFICATION = {
    "prev": BertForTokenClassification,
    ...
    "ourbert":BertForTokenClassification
}

MODEL_FOR_QUESTION_ANSWERING = {
    "prev":BertForQuestionAnswering,
    ...
    "ourbert": BertForQuestionAnswering
}
